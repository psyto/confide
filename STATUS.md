...
0f. **⚠ 保有分布を測った。今のピッチに不利な事実が出た（2026-09-21）** —
   ...
   | mint | 残高>0 | 中央値 | **1株未満** |
   |---|---|---|---|
   | NVDAx | 99,028 | 0.0046 | **98.0%** |
   | AAPLx | 35,754 | 0.0013 | **98.6%** |
   | ANTHROPIC | 37,719 | 0.0067 | **95.7%** |
   | AMC.US | 4,236 | 0.0014 | **98.8%** |

   **口座数は塵。** NVDAx の中央値は**1株の0.0046**（約80セント）。3発行体4銘柄すべてで
   96〜99% が**1株未満**、上位1%が 85〜99% を持つ。
...
0e. **Confidential Issuance & Redemption の評価（2026-09-21）** —
   ...
   - **より強い主張が隣にある** — SEC が配当と議決権を要求した。**残高を読めない保有者に
     按分で配当は払えない。** 発行は良い*デモ*、コーポレートアクションは良い*論拠*

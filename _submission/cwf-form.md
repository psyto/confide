...
Cropped from `web/poster.jpg`, which is a real frame of the delivered video rather than a mock.
The frame is 16:9 with a quarter of its height empty top and bottom; on a project card that becomes
letterboxing and unreadable text. Cropped to the content band the whole product reads at tile size:
two parties, the two legs, nobody in the middle, and what the chain shows everyone else.

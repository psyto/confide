//! Emit an unsigned transaction that hands Confide's **own** NAV-floor proof to Solana's live
...
//! `confide-equity::nav_floor_disclosure` produced, the same package the embargo seals. So
